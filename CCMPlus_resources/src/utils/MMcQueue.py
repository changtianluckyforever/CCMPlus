...
class MMcQueue(object):
    ...
    def get_avg_packets_in_queue(self):
        """
        Return the average number of packets in the system (in service and in the queue)
        """
        return self.get_avg_packets() - self._capacity * self._rou
...
if __name__ == '__main__':
    ...
    print("getAvgResponseTime ", thisQueue.getAvgResponseTime())
    print("Avg. Queuing Time: \t\t\t", thisQueue.getAvgQueueTime())
    print("getAvgQueuePacket_Given ", thisQueue.get_avg_packets(), thisQueue.getAvgPacketInSystem(),
          thisQueue.get_avg_packets_in_queue())
